...
export const SNAPSHOT_ALGORITHM_VERSION = "2026-07-20.3-publication-history";
...
function buildSourceIntegrity({ packageIntegrity, moduleHistory, ownerHistory, userRows, packageRows, latestPackageRows, downloadRows }) {
